...
const Formdata = (props) => {
  ...
  const handlecountry = (e) => {
    ...
    const getStatedata = countryState.find(
    ...
    const countryMobileCodeData = countryMobileCode.find(
      (country) => country.name === getStatedata.country_name
    );
  ...
  const handlestate = (e) => {
    ...
    const selectedStateIdd = getStatedata.states.find(
  ...
  const submitForm = (e) => {
    ...
    axios
      .post("http://localhost:3001/form/save-details", values)
          ...
          <div className="state">
            ...
            >
              ...
              {state.map((getstate, index) => (
                <option value={getstate.state_id} key={index} className="input">
                  {getstate.state_name}
                </option>
              ))}
            </select>
